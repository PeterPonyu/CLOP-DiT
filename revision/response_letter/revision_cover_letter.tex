...
\begin{itemize}
  ...
  \item \textbf{Ablation section} (Section~3.10, Table~\ref{tab:zca-ablation}): Added formal
  ...
  \item \textbf{New Results Section~3.13} \emph{Strict-OOD Generalization (Zero-Shot)}:
    ...
    gonadal tissue (Figure~\ref{fig:strict-ood} and Table~\ref{tab:strict-ood}).
...
the contribution more precisely and more honestly than the original version. We appreciate the
