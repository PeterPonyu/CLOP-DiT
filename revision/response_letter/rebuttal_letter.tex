...
\begin{itemize}
  ...
  \item The Visual Conflict Detection (VCD) pass on the regenerated PDFs records zero residual text-on-text overlaps across Figures~1, 2, and~11, down from 11 flagged overlaps in the original submission. Figure~11(c) specifically was re-laid out so the legend sits outside the data panel, and its axis-label font was raised from $9\,\text{pt}$ to $11\,\text{pt}$ for print legibility. \msref{Figure~11(c)}
\end{itemize}
