...
\noindent\textbf{Manuscript changes:}
\begin{itemize}
  \item Added organism-stratified evaluation paragraph with per-organism metrics. \msref{Section~3.4}
\end{itemize}
...
\begin{itemize}
  ...
  \item Added augmentation strategy sweep and forced-scarcity results (table reproduced above). \msref{Section~3.11}
