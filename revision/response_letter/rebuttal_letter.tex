...
\noindent\textbf{Manuscript changes:}
\begin{itemize}
  \item Added a KNN error-taxonomy subsection with the family-level analysis and a new 10-family confusion heatmap (Figure~\ref{fig:knn-family-heatmap} in Appendix~\ref{app:suppl-figs}). \msref{Section~3.4, Appendix~A.1}
\end{itemize}
...
\noindent\textbf{Manuscript changes:}
\begin{itemize}
  \item Added organism-stratified evaluation paragraph with per-organism metrics and a new 6-panel boxplot (Figure~\ref{fig:organism-stratified} in Appendix~\ref{app:suppl-figs}) visualising all five Mann--Whitney tests. \msref{Section~3.4, Appendix~A.1}
\end{itemize}
...
\begin{itemize}
  ...
  \item Added augmentation strategy sweep and forced-scarcity results (table reproduced above); F1 trajectories across both scarcity regimes are now plotted in Figure~\ref{fig:forced-scarcity} (Appendix~\ref{app:suppl-figs}). \msref{Section~3.11, Appendix~A.1}
