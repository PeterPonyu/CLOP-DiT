...
\noindent\textbf{Manuscript changes:}
\begin{itemize}
  \item Added explicit interpretation of the residual-distribution and tolerance-band panels. \msref{Section~3.5}
  \item Connected HVG standard-deviation ratios to the first-order vs.\ second-order fidelity narrative. \msref{Section~3.5}
\end{itemize}
...
\noindent\textbf{Manuscript changes:}
\begin{itemize}
  \item Added the zero-shot strict-OOD paragraph with per-tissue metrics (Table~\ref{tab:strict-ood} and Figure~\ref{fig:strict-ood} in the main text). \msref{Section~3.13}
  \item Kept the interpolation-vs-extrapolation clarification on the 8-study held-out split. \msref{Section~3.13}
  \item Reframed existing OOD prompt tests as exploratory and preliminary. \msref{Section~3.13 and Appendix~\ref{app:suppl-figs}}
\end{itemize}
...
\noindent\textbf{Manuscript changes:}
\begin{itemize}
  \item Added formal ZCA ablation results (Table~\ref{tab:zca-ablation} in the main text). \msref{Section~3.10}
\end{itemize}
...
R3.1 & Experiment & Sec.~3.13, Table~\ref{tab:strict-ood} & Added zero-shot strict-OOD evaluation \\
...
R3.4 & Experiment & Sec.~3.10, Table~\ref{tab:zca-ablation} & Added formal ZCA whitening ablation \\
\midrule
