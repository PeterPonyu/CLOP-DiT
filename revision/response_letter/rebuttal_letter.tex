...
\begin{center}
\includegraphics[width=0.86\textwidth]{../manuscripts/v2_revision/figures/figS_lane_c_zero_shot.pdf}

\small Figure preview used in the revised manuscript: strict-OOD nearest-centroid accuracy by tissue and novel cell type.
\end{center}
