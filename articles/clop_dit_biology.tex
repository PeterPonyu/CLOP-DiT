...
\Author{Zeyu Fu $^{1,\dagger}$\orcidA{}, Jiawei Fu $^{2,\dagger}$, Chunlin Chen $^{3,\dagger}$, Keyang Zhang $^{4}$, Junping Wang $^{1,}$, Tianfei Ran $^{2,}$* and Song Wang $^{1,}$*}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Zeyu Fu, Jiawei Fu, Chunlin Chen, Keyang Zhang, Junping Wang, Tianfei Ran and Song Wang}

% Affiliations / Addresses
\address{%
$^{1}$ \quad State Key Laboratory of Trauma and Chemical Poisoning, Institute of Combined Injury, Chongqing Engineering Research Center for Nanomedicine, College of Preventive Medicine, Army Medical University, Chongqing 400038, China\\
$^{2}$ \quad Department of Orthopedics, Xinqiao Hospital, Army Medical University, Chongqing 400037, China\\
$^{3}$ \quad Department of Rehabilitation Medicine, The First Affiliated Hospital, Sun Yat-sen University, Guangzhou 510080, China\\
$^{4}$ \quad School of Medicine, Sun Yat-sen University, Shenzhen 518107, China}

% Contact information of the corresponding authors
\corres{Correspondence: rantianfei@tmmu.edu.cn (T.R.); swang1981@tmmu.edu.cn (S.W.)}
...
\acknowledgments{The authors acknowledge the developers and communities behind scGPT, BiomedBERT, and the Gene Expression Omnibus (GEO) for providing open-access tools and datasets that made this work possible.}
