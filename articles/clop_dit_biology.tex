...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{figures/fig01_architecture.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig02_evaluation_pipeline.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig03_training_dynamics.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig04_embedding_space.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig05_metrics_summary.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig06_per_type_fidelity.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig07_text_cell_alignment.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig08_marker_genes.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig09_expression_correlation.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig10_expression_analysis.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig11_conditioning_umap.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig12_diversity_diagnostics.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/fig13_noise_tradeoff.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig14_expression_diversity.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig15_baseline_comparison.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig16_benchmark.jpg}
\caption{Composite benchmark across eight methods including scGen and scVI Latent external baselines. (\textbf{a})~Normalized metrics heatmap (methods $\times$ metrics; green = high performance). (\textbf{b})~Composite score, with hatched bars denoting the common-metrics-only composite and solid bars denoting the full 17-metric composite. (\textbf{c})~Grouped comparison of four interpretable benchmark metrics across methods. (\textbf{d})~95\% confidence intervals for FD, centroid cosine, and diversity ratio.\label{fig:benchmark}}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig17_downstream_pq.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig18_de_concordance.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig19_variance_matching_pilot.jpg}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig20_gene_gene_correlation.jpg}
...
We introduced CLOP-DiT, a two-stage pipeline for structured-metadata-conditioned single-cell latent generation. CLOP aligns BiomedBERT text embeddings and scGPT cell embeddings in a shared 512-dimensional space, and a conditional Diffusion Transformer then samples scGPT latents from a fixed five-field biological template. The method is therefore best interpreted as a structured-metadata-to-latent conditional sampler rather than a free-form language model. Across 69 deduplicated cell types from 80 datasets, CLOP-DiT achieves 36.9\% KNN accuracy and 81.0\% steering in a high-fidelity regime, while a high-diversity regime reaches a diversity ratio of 0.93 at 80.7\% steering. Multi-seed replication confirms that steering and diversity are stable across independent runs.

The central limitation is equally clear. A frozen scGPT decoder makes expression-level evaluation many-to-one, and the model does not preserve within-population heterogeneity well enough for variance-sensitive biological applications. Although decoder-reconstructed gene means are highly concordant with real data, per-gene variance correlation is near zero, gene--gene correlation structure is weakly preserved, and rare-cell augmentation remains negative. CLOP-DiT therefore demonstrates feasibility rather than readiness: structured metadata can drive meaningful latent generation, but practical biological use will require better variance preservation, covariance-aware training, and a decoder that does not collapse distinct latent states to near-identical expression outputs.
