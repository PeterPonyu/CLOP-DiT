...
def plot_diagnostics(
    ...
    """Generate diagnostic figures from all test results."""
    out = Path(output_dir)
    ...
    if t2:
        ...
        bars = ax.bar(labels, vals, color=["#F44336", "#FF9800", "#4CAF50", "#2196F3", "#FF9800", "#F44336"],
    ...
    if t3:
        ...
        ax.set_title("J3: CFG Scale vs Diversity & Norm")
    ...
    if t6 and t6.get("overall"):
        ...
        ax.set_title("K1: Expression Variability Summary")
        ax.legend()

        # K2: Per-type gene std ratio
        ax = axes[1]
        ...
        if pt_ratio:
            ...
            ax.set_title("K2: Per-Type Gene Std Ratio")
            ax.legend(fontsize=8)
